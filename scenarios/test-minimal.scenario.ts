...
const scenario: ScenarioDefinition = {
  ...
  patterns: [
    {
      ...
      trajectory: {
        ...
        snapshots: [
          { month: '2024-07', denialRate: 32, dollarsDenied: 4800 },
          { month: '2024-08', denialRate: 28, dollarsDenied: 4200 },
          { month: '2024-09', denialRate: 20, dollarsDenied: 3000 },
          { month: '2024-10', denialRate: 15, dollarsDenied: 2250 },
          { month: '2024-11', denialRate: 12, dollarsDenied: 1800 },
          { month: '2024-12', denialRate: 8, dollarsDenied: 1200 },
        ],
      },
      engagement: {
        firstViewedDate: '2024-07-10',
        totalViews: 25,
        claimLabTests: 8,
        claimsExported: 15,
        actionsRecorded: [
    ...
    },
    {
      ...
      trajectory: {
        ...
        snapshots: [
          { month: '2024-07', denialRate: 32, dollarsDenied: 12800 },
          { month: '2024-08', denialRate: 30, dollarsDenied: 12000 },
          { month: '2024-09', denialRate: 28, dollarsDenied: 11200 },
          { month: '2024-10', denialRate: 27, dollarsDenied: 10800 },
          { month: '2024-11', denialRate: 26, dollarsDenied: 10400 },
          { month: '2024-12', denialRate: 24, dollarsDenied: 9600 },
        ],
      },
      engagement: {
        firstViewedDate: '2024-07-15',
        totalViews: 18,
        claimLabTests: 5,
        claimsExported: 10,
        actionsRecorded: [],
  ...
  learningEvents: {
    ...
    eventClustering: {
      'MOD25-MISSING': ['2024-08-15', '2024-08-16', '2024-09-01'],
      'AUTH-MISSING': ['2024-07-15', '2024-07-20'],
    },
  },
